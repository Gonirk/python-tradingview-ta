...
def calculate(indicators, indicators_key, screener, symbol, exchange, interval):
    ...
    if indicators[91] != None:  # Укажите индекс SMC в списке индикаторов
        computed_oscillators["SMC"] = Compute.SMC(indicators[91])
        oscillators_counter[computed_oscillators["SMC"]] += 1
